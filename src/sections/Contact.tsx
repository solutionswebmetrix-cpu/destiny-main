        ...
        <Reveal>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p className="section-subtitle">
              Have a question or want to book a consultation? Reach out - our team responds within 24 hours.
            </p>
          </div>
        </Reveal>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.1fr', gap: 40 }} className="contact-grid">
          <Reveal>
            <div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="card"
                style={{ padding: 0, overflow: 'hidden', height: 280 }}
              >
                <iframe
          ...
          <Reveal delay={0.12}>
            <div className="card" style={{ padding: 36 }}>
              <h3 style={{ fontSize: '1.3rem', marginBottom: 8 }}>Send Us an Inquiry</h3>
              <p className="muted" style={{ fontSize: '0.88rem', marginBottom: 24 }}>Fill in your details and we'll get back to you shortly.</p>
