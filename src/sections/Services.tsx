...
import imgArchitecture from '../assets/Architecture.jpg'
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 26 }}>
          {services.map((s, i) => (
            <Reveal key={s.title} delay={i * 0.07}>
              ...
              >
                {/** Display service image instead of icon (kept consistent styling) */}
                <motion.div
                ...
                >
                  <img src={[imgResidential, imgCommercial, imgInterior, imgArchitecture, imgRenovation, imgResidential][i]} alt={s.title} style={{ width: 40, height: 40, objectFit: 'cover', borderRadius: 8 }} loading="lazy" />
                </motion.div>
